CLASS zcl_171422001_select_cds DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_171422001_select_cds IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    TRY.
        ...
        out->write(
          |Airport from id is: { airport_from_id } Airport to id is { airport_to_id }|
        ).
